...
class p1(wx.Panel):
    def __init__(self, parent):
        wx.Panel.__init__(self, parent, -1, size=(600,1000))
...
class TestFrame(wx.Frame):
    def __init__(self, parent, title):
        wx.Frame.__init__(self, parent, title=title, size=(830, 850))
        self.sp = wx.SplitterWindow(self)
        # self.p1 = wx.Panel(self.sp, style=wx.SUNKEN_BORDER)
        self.p1 = p1(self.sp)
        self.p2 = wx.Panel(self.sp, style=wx.SUNKEN_BORDER)
        self.sp.SplitVertically(self.p1, self.p2, 645)
        self.statusbar = self.CreateStatusBar()
        self.statusbar.SetStatusText("Hola")

        self.siButton = wx.Button(self.p2, -1, "Si", size=(40,20), pos=(10,10))
